...
export default function Intro() {
  ...
  return (
    <div className="flex flex-row  h-screen f-screen ">
      <div
        className="  h-full  w-3/4 bg-cover bg-center inline-block  text-white ease-in duration-1000"
        style={{ backgroundImage: `url(${currentImage})` }}
      ></div>

      <div className="flex flex-col w-1/4">
        <div className=" h-full w-full flex flex-col justify-center items-center ">
          <div className="  h-2/5 w-3/4 bg-cover bg-center bg-[url('./images/Techmo.png')] rounded-xl hover:-translate-y-10 duration-1000"></div>
          <h1 className="mb-6 font-bold mt-8  text-2xl ">Se connecter </h1>
          <LoginBtn />
        </div>
        <div>
          <h1 className="mb-6 font-semibold mt-8 text-center text-2xl">
            Par TechMo{" "}
          </h1>
        </div>
      </div>
